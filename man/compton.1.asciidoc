...
*--inactive-dim-red* 'VALUE'::
  Red color value of dim (0.0 - 1.0, defaults to 0).

*--inactive-dim-green* 'VALUE'::
  Green color value of dim (0.0 - 1.0, defaults to 0).

*--inactive-dim-blue* 'VALUE'::
  Blue color value of dim (0.0 - 1.0, defaults to 0).

*--inactive-dim-exclude* 'CONDITION'::
  Specify a list of conditions of windows that should not be dimmed.
