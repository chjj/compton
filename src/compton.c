...
#define WARNING
  const static char *usage_text =
    ...
    "  --config                       Look for configuration file at the specified path.\n"
    ...
    "                                 Defaults to 0.\n"
    "  --unredir-if-possible-exclude  Conditions of windows that shouldn't be considered full-screen\n"
    "                                 for unredirecting screen.\n"
    "  --focus-exclude condition      Specify a list of conditions of windows that should always be\n"
    "                                 considered focused.\n"
    ...
    "                                 opacity.\n"
    "  --blur-kern matrix             Specify the blur convolution kernel, with the following format:\n"
    "                                 WIDTH,HEIGHT,ELE1,ELE2,ELE3,ELE4,ELE5...\n"
    "                                 The element in the center must not be included, it will be forever\n"
    "                                 1.0 or changing based on opacity, depending on whether you have\n"
    "                                 --blur-background-fixed.\n"
    "  --blur-kern                    Up to 4 blur kernels may be specified, separated with semicolon, for\n"
    "                                 multi-pass blur. May also be one the predefined kernels:\n"
    "                                 3x3box (default), 5x5box, 7x7box, 3x3gaussian, 5x5gaussian,\n"
    ...
    "  --shadow-exclude-reg geometry  Specify a X geometry that describes the region in which shadow\n"
...
#define WARNING
    ...
    "                                 screen." WARNING "\n"
    "  --backend backend              Choose backend. Possible choices are xrender, glx, and\n"
    ...
    "  --glx-swap-method              GLX backend: GLX buffer swap method we assume. Could be\n"
